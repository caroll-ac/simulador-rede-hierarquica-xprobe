...
ips_e1 = generate_ips("192.168.1.0/28", num_hosts_e1, "1")  # e.g., 192.168.1.1, 192.168.1.2...
ips_e2 = generate_ips("192.168.1.32/28", num_hosts_e2, "2") # e.g., 192.168.1.33, 192.168.1.34...
ips_e3 = generate_ips("192.168.1.64/27", num_hosts_e3, "3") # e.g., 192.168.1.65, 192.168.1.66...
ips_e4 = generate_ips("192.168.1.80/27", num_hosts_e4, "4") # e.g., 192.168.1.81, 192.168.1.82...
